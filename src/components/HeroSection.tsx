      ...
      <div className="section-container relative z-10 py-8 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Expert guidance for global education. From university selection to visa 
              processing – we make your international education dreams come true.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                >
                  <span className="text-foreground font-bold text-sm">1K+</span>
                </motion.div>
                <span className="text-white/80 text-sm">Students Enrolled</span>
              </div>
              <div className="flex items-center gap-2">
                <motion.div
                  initial={{ scale: 0 }}
